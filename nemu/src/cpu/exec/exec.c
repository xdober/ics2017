...
make_group(gp3,
    ...
    EXW(mul, 1), EX(imul1), EX(div), EX(idiv))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x30 */	IDEXW(G2E, xor, 1), IDEX(G2E,xor), IDEXW(G2E, xor, 1), EMPTY,
  /* 0x34 */	EMPTY, IDEX(I2a, xor), EMPTY, EMPTY,
  /* 0x38 */	IDEXW(E2G, cmp, 1), IDEX(G2E, cmp), EMPTY, IDEX(E2G, cmp),
  /* 0x3c */	IDEXW(I2a, cmp, 1), IDEX(I2a, cmp), EMPTY, EMPTY,
  /* 0x40 */	IDEX(r, inc), IDEX(r, inc), IDEX(r, inc), IDEX(r, inc),
  /* 0x44 */	EMPTY, EMPTY, IDEX(r, inc), IDEX(r, inc),
  /* 0x48 */	IDEX(r, dec), IDEXW(r, dec, 2), IDEX(r, dec), IDEX(r, dec),
  ...
  /* 0xa8 */	IDEXW(I2r, test, 1), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, IDEX(J,ret),
  ...
  /* 0x80 */	EMPTY, EMPTY, EMPTY, IDEX(J, jcc),
  ...
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G, movzx, 1), IDEXW(mov_E2G, movsx, 2),
