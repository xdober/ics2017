...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	EMPTY, IDEX(r, push), EMPTY, IDEX(r, push),
  /* 0x54 */	EMPTY, IDEX(r, push), IDEX(r, push), EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G, mov, 1), EMPTY,
